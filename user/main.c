...
int main(void)
{
  ...
  printf("INTERNAL TEMPERATURE SENSOR ACTIVATE\r\n");
  ...
  while(1)
  {
...
#ifdef Debug
	printf("DMA_FDT1_FLAG: %d \r\n", dma_flag_get(DMA1_FDT1_FLAG));
#endif
	...
	delay_sec(1);
	  ...
	  printf("ADC_VALUE = %x\r\n",adc1_ordinary_value);
	  printf("internal_temperature = %lf deg C\r\n",(ADC_TEMP_BASE - (long double)adc1_ordinary_value * ADC_VREF / 4096) / ADC_TEMP_SLOPE + 25);
	  delay_sec(1);
	  at32_led_toggle(LED3);
  }
}
